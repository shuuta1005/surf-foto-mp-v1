...
// import { useIsMobile } from "@/lib/hooks/useIsMobile"; // ✅ import the hook
...
//         {/* Grid for md+, horizontal scroll for mobile */}
//         {isMobile ? (
...
//                   className="flex-shrink-0 w-48 p-2 bg-white rounded-lg hover:bg-gray-100 cursor-pointer border border-stone-100"
//                 >
