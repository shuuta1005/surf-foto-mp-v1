...
// UPDATED VERSION - Handles photographer accounts in resend emails
    ...
    try {
      await resend.emails.send({
        ...
        subject: isPhotographer
          ? "Your new BrahFotos Photographer verification code"
          : "Your new BrahFotos verification code",
...
${
  isPhotographer
    ? "Once verified, your photographer application will be reviewed by our team within 2-3 business days.\n\n"
    : ""
...
The BrahFotos Team`,
        html: `
          <div style="max-width:600px; margin:0 auto; padding:20px; font-family: Arial, sans-serif; color: #333;">
            ...
            <p>Here's your new verification code for BrahFotos${
              isPhotographer ? " Photographer Account" : ""
            }:</p>
            ...
            <div style="background: #e0f2fe; border-left: 4px solid #0284c7; padding: 15px; margin: 20px 0;">
              ...
              <ul style="margin: 10px 0;">
                ...
                <li>Once approved, start uploading and earning 90% on every sale!</li>
              </ul>
            </div>
            `
                : ""
